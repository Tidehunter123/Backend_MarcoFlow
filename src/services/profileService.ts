...
export const createProfileData = async (userProfileData: any) => {
  try {
      ...
      messages: [
        {
          ...
          # 📌 Step 1: User Inputs 
            user_data = {
                "date_of_birth": ${userProfileData.dateOfBirth},  # DD/MM/YYYY
                "gender": ${userProfileData.gender},  # "male" or "female"
                "height_cm": ${userProfileData.height},
                "weight_kg": ${userProfileData.weight},
                "activity_level": ${userProfileData.activityLevel},  # Options: "sedentary", "active", "very_active"
                "training_history": ${userProfileData.trainingHistory},  # "beginner", "intermediate", "advanced"
                "workouts_per_week": ${userProfileData.workoutsPerWeek},  # 3, 4, or 5 days per week
                "training_goal": ${userProfileData.trainingGoal},  # "fat_loss", "muscle_gain", "recomposition", "strength_gain", "athletic_performance", "fitness_model" etc.
                "weekly_weight_change_kg": ${weightPerWeek},  # User selects kg per week (Can be None)
                "nutrition_preference": ${userProfileData.selectedStyle}  # "balanced", "low_carb", "keto", "low_fat", etc.
            }
